...
Prototype full-stack : invitations par code, création de compte, questionnaire sans critère d'apparence physique, avec âge, genre et préférences de rencontre, profil modifiable, calcul global des paires, publication du match et espace administrateur.
...
Cette version n’utilise **aucune photo, taille, poids, couleur de cheveux, attractivité ou autre critère d’apparence physique**. Elle demande l’âge, le genre et les préférences de genre/âge uniquement comme contraintes d’éligibilité réciproques avant le calcul de personnalité. Elle ne demande pas d’origine, religion ou opinion politique.
